import TagFilter from "../../../../entity/filter/tag_filter_data";
import TimeFilter from "../../../../entity/filter/time_filter_data";
import WorkData from "../../../../entity/work_data";
import IFilter from "../../../../entity/filter/filter_data";
import NameFilter from "../../../../entity/filter/name_filter_data";
...
export default class Filter {
    ...
    filter(work: WorkData): boolean {
        if (implementsNameFilter(this.data)) {
            const filename = work.path.split("\\").pop()
